...
from eagle_eyes.settings import AMAZON_S3_STORAGE_ACCESS_KEY
from eagle_eyes.settings import AMAZON_S3_STORAGE_SECRET_KEY


class AmazonS3ImageStorage(S3Boto3Storage):
    bucket_name = 'gfs-media-prod'
    location = 'images'
    access_key = AMAZON_S3_STORAGE_ACCESS_KEY
    secret_key = AMAZON_S3_STORAGE_SECRET_KEY
    endpoint_url = 'https://cmn-prod-rgw.kp0.mci.dev/'
